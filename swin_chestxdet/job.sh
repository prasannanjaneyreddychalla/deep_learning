#!/bin/bash -l
#SBATCH --job-name=swin_chestxdet
...
#SBATCH --output=/scratch/pchalla7/output/chestxdet_%A.out
#SBATCH --error=/scratch/pchalla7/output/chestxdet_%A.err
...
set +u
source activate /home/pchalla7/.conda/envs/chestxdet
set -u
hash -r

PY="/home/pchalla7/.conda/envs/chestxdet/bin/python"
